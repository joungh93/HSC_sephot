...
upper_limit = 10.    # upper limit of pixel values


# ----- Photometric parameters ----- #

## General
use_backsub = False  # if True, SExtractor photometry will be applied to background-subtracted images
MAG0 = 27.0  # MAG_ZEROPOINT
SEEING0 = 0.7  # SEEING_FWHM
GAIN0 = [12600, 9900, 9900]  # effective gain

## PSFEx
THRES_psf = 10  # DETECT_THRESH
FWHMR_psf = [3.0, 5.0]  # SAMPLE_FWHMRANGE
MINSN_psf = 5.0  # SAMPLE_MINSN
...
APHOT = False  # if True, you will do aperture photometry
APERs = '4.0,6.0,8.0,10.0,12.0,18.0,24.0,33.3'  # apertures for MAG_APER
